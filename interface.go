...
type Config struct {
	...
	// AdditionalClientTransportParameters appends application-defined transport
	// parameters to client handshakes. It is an ixa fork extension and is ignored
	// by servers. IDs used by QUIC itself must not be supplied here.
...
// TransportParameter is an opaque QUIC transport parameter.
// It is an ixa fork extension used to reproduce parameters sent by Chromium.
